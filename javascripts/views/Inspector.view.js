define(["BaseView",
  ...
  'lib/utils'], function(
    BaseView, InspectorModel, ResponseListener, XMPPStreamView, StreamToolbarView, Streams, Stream, inspectorTemplate, Utils
  ) {
  "use strict";
  ...
  return BaseView.extend({
    ...
    render: function(){
      ...
      this.renderToolbar(this.model.streams.at(0).attributes);
    },
